...
crop_size = (64, 64, 64)
## Note
checkpoint_name= 'model_3d'
note_S='Seg_3d(Adam lr_S: ' + str(lr_S) + ',w_decay:1e-4' + 'beta:' +str(beta1)+ ',' + str(beta2) + ',' + 'step:' + str(step_size_S) + ' , lr_step)'
note_D='Seg_3d(Adam lr_S: ' + str(lr_S) + ',w_decay:1e-4' + 'beta:' +str(beta1)+ ',' + str(beta2) + ',' + 'step:' + str(step_size_S) + ' , lr_step)'

num_checkpoint='19999'
